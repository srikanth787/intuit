	In AWS, using automation (cloudformation, troposphere or terraform or equivalent) and configuration management (Chef or puppet or Ansible or equivalent), create an application stack and do the following: 
